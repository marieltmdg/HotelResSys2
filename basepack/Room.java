...
public abstract class Room {
    ...
    */
    ...
    public abstract double getTotalPriceAfterDiscount(int promoValidity, int checkIn, int checkOut);

    public abstract double[] getPriceAfterDiscountBreakdown(int promoValidity, int checkIn, int checkOut) ;

    public abstract String[] priceBreakdown(int promoValidity, int checkIn, int checkOut) ;
